...
//export const profileMajor = document.querySelector(".profile__major");
...
//export const inputFieldPict = document.querySelector(
//   ".popup__container-input_field_pict"
//);
//export const inputFieldPlace = document.querySelector(
